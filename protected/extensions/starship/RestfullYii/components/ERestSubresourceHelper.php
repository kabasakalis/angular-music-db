...
class ERestSubresourceHelper implements iERestResourceHelper
{
   ...
   /*     fb($subresource_name,'$subresource_name');
        fb( $model->relations(),' $model->relations()');
        fb(CActiveRecord::MANY_MANY,' CActiveRecord::MANY_MANY');
        fb($model->relations()[$subresource_name][0],' $model->relations()[$subresource_name][0]');
fb($model->relations()[$subresource_name][0] != CActiveRecord::MANY_MANY,'COMPARISON');*/
